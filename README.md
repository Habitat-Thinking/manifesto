...
Habitat Thinking treats that whole place — the people, the agents, the relationships between them, and the code, conventions, and feedback loops they share — as a habitat, and asks the oldest question habitability ever posed: is this a good place to live? Through doing this work, and helping others do it, we have come to value:

**The whole cognition in the room** over the code on the screen

**Sustained human understanding** over the throughput of the place

**The living theory the inhabitants hold** over the artefacts that embody it

**Designing the collaboration** over directing the tool

**Orientation that outlives the tools** over tactics tuned to today's models

**Judgment that compounds** over volume that impresses
...
Version 1.1.0, September 2026. The document is expected to change. Cite the version you agreed with: disagreement is only useful when it can be traced to what it disagreed with. See [CHANGELOG.md](CHANGELOG.md) for what changed between versions.
